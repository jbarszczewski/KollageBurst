namespace KollageBurstLib
{
    ...
    {
        public static System.Windows.Media.Color GetAverageColor(this WriteableBitmap source, int top = 0, int left = 0, int height = 0, int width = 0)
        {
            if (width == 0)
            {
